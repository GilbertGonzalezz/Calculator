...
//  Calculator
//
//  Created by Gilbert Gonzalez on 4/23/21.
//
...
class ViewController: UIViewController {
    ...
    private var resultLabel: UILabel = {
        ...
        label.font = UIFont(name: "Arial-Bold", size: 80)
        return label
    }()
    ...
    private func setupNumberPad() {
        ...
        for x in 0..<5 {
            ...
            button4.tag = x+1
            button4.addTarget(self, action: #selector(operationsPressed(_:)), for: .touchUpInside)
}
        resultLabel.frame = CGRect(x: 20, y: clearButton.frame.origin.y - 1150.0, width: view.frame.size.width - 40, height: 100)
